...
export default function Home() {
  ...
  return (
    <motion.main 
      ...
      className="flex flex-col items-center justify-center min-h-screen text-center px-4 relative z-0 overflow-hidden"
    >
      {/* Liquid Dream Mesh Background */}
      <motion.div 
      ...
      >
        <motion.div
          ...
          className="absolute w-[120vw] h-[120vw] max-w-[1200px] max-h-[1200px] bg-[radial-gradient(circle_at_center,#082032,#02080d)] blur-[140px] top-[-30%] left-[-20%] opacity-70"
        />
        <motion.div
          animate={{
            x: ["0%", "-30%", "20%", "0%"],
            ...
            rotate: [360, 180, 90, 0],
            scale: [1, 0.8, 1.4, 1],
            borderRadius: ["40%", "70% 30% 30% 70% / 70% 70% 30% 30%", "30% 70% 70% 30% / 30% 30% 70% 70%", "40%"],
          }}
          transition={{ duration: 32, repeat: Infinity, ease: "easeInOut" }}
          className="absolute w-[100vw] h-[100vw] max-w-[1000px] max-h-[1000px] bg-[radial-gradient(circle_at_center,#0f304a,#030c14)] blur-[130px] bottom-[-40%] right-[-30%] opacity-60"
        />
        <motion.div
          animate={{
            x: ["-20%", "20%", "-20%"],
            ...
            rotate: [0, 180, 360],
            scale: [1, 1.2, 1],
            borderRadius: ["60%", "30% 70% 70% 30% / 30% 30% 70% 70%", "60%"],
          }}
          transition={{ duration: 28, repeat: Infinity, ease: "easeInOut" }}
          className="absolute w-[90vw] h-[90vw] max-w-[900px] max-h-[900px] bg-[radial-gradient(circle_at_center,#0a253a,#010910)] blur-[120px] top-[10%] left-[20%] opacity-50"
        />
      </motion.div>

      {/* Techy HUD Overlay Elements */}
      <motion.div 
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        ...
        {/* Corner Crosshairs - Delicately sized */}
        ...
        {/* Center Reticle - Very subtle, organic dashed line */}
        ...
        {/* Floating Poetic Data Nodes - Replacing template boilerplate with emotional indicators */}
        {[
      ...
      >
        ...
        >
          ...
          {/* Subtle ghosted under-layer for physical depth */}
          <h1 
      ...
      >
        ...
        >
          ...
          >
            ...
            {/* Inner Blur / Glow effect on hover */}
